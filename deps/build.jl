...
source_uri = URI("https://github.com/ARMmbed/mbedtls/archive/mbedtls-2.1.1.tar.gz")

provides(Sources,
        source_uri,
        mbed_all, unpacked_dir="mbedtls-mbedtls-2.1.1")

@unix_only begin
    mbed_dir = joinpath(BinDeps.depsdir(mbed), "src", "mbedtls-mbedtls-2.1.1")
